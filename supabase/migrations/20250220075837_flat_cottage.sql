/*
  # Création de la table exercises et import des données

  1. Structure
    - Table `exercises` avec toutes les colonnes nécessaires
    - Support des exercices droite/gauche
    - Support des niveaux et thèmes
    - Support des mots-clés (array)
  ...
  3. Données
    ...
    - Conversion des séparateurs spécifiques pour les mots-clés
*/

/*
  ...
  1. Structure
    - Crée la table `exercises` avec tous les champs nécessaires
    - Ajoute les contraintes et valeurs par défaut
    - Active RLS avec politique de lecture pour les utilisateurs authentifiés

  2. Données
    - Insère tous les exercices du fichier CSV
    - Convertit les données au format approprié
*/

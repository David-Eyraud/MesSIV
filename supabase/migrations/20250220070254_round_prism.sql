/*
  # Mise à jour de la table exercises et insertion des données initiales

  1. Structure
    - Ajout des colonnes manquantes à la table exercises
    - Modification des types de données pour correspondre au CSV

  2. Données
    - Insertion des exercices initiaux depuis le CSV
*/

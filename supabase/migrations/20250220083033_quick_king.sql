/*
  # Ajout de tous les exercices

  1. Structure
    - Supprime la table exercises si elle existe
    - Recrée la table avec la structure complète
    - Active RLS et ajoute la politique de lecture

  2. Données
    - Ajoute tous les exercices avec leurs niveaux respectifs :
      - Tous niveaux
      - Brevet de pilote
